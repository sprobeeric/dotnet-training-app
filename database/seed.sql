...
VALUES
    ('PR-1001', 1, current_date - 13, 500.00, 'BankTransfer', 'REF-1001', 'Partial payment received.', now() at time zone 'utc', now() at time zone 'utc'),
    ('PR-1002', 1, current_date - 10, 875.00, 'Cash', 'REF-1002', 'Remaining balance paid.', now() at time zone 'utc', now() at time zone 'utc'),
    ('PR-1003', 2, current_date - 28, 902.00, 'Card', 'REF-1003', 'Full payment settled.', now() at time zone 'utc', now() at time zone 'utc'),
    ('PR-1004', 1, current_date - 9, 250.00, 'Card', 'REF-1004', 'Additional service payment.', now() at time zone 'utc', now() at time zone 'utc'),
    ...
    ('PR-1007', 2, current_date - 22, 150.00, 'BankTransfer', 'REF-1007', 'Support extension.', now() at time zone 'utc', now() at time zone 'utc'),
    ('PR-1008', 1, current_date - 7, 200.00, 'Card', 'REF-1008', 'Consulting add-on.', now() at time zone 'utc', now() at time zone 'utc'),
    ('PR-1009', 2, current_date - 20, 100.00, 'Card', 'REF-1009', 'Adjustment payment.', now() at time zone 'utc', now() at time zone 'utc'),
    ...
    ('PR-1012', 1, current_date - 5, 320.00, 'BankTransfer', 'REF-1012', 'Additional project payment.', now() at time zone 'utc', now() at time zone 'utc'),
    ('PR-1013', 2, current_date - 16, 225.00, 'Card', 'REF-1013', 'Hardware reimbursement.', now() at time zone 'utc', now() at time zone 'utc'),
    ('PR-1014', 1, current_date - 4, 180.00, 'Card', 'REF-1014', 'Training session payment.', now() at time zone 'utc', now() at time zone 'utc'),
    ...
    ('PR-1017', 2, current_date - 12, 210.00, 'BankTransfer', 'REF-1017', 'Operational support.', now() at time zone 'utc', now() at time zone 'utc'),
    ('PR-1018', 1, current_date - 2, 140.00, 'Card', 'REF-1018', 'Technical assistance.', now() at time zone 'utc', now() at time zone 'utc'),
    ('PR-1019', 2, current_date - 11, 350.00, 'Card', 'REF-1019', 'Additional maintenance.', now() at time zone 'utc', now() at time zone 'utc'),
    ...
    ('PR-1022', 1, current_date - 8, 610.00, 'BankTransfer', 'REF-1022', 'Bulk consulting fee.', now() at time zone 'utc', now() at time zone 'utc'),
    ('PR-1023', 2, current_date - 7, 80.00, 'Card', 'REF-1023', 'License renewal.', now() at time zone 'utc', now() at time zone 'utc'),
    ('PR-1024', 1, current_date - 6, 95.00, 'Card', 'REF-1024', 'Administrative fee.', now() at time zone 'utc', now() at time zone 'utc'),
