...
public class PaymentReceiptControllerTests
{
    ...
    public async Task Index_WithoutPagingParameters_UsesDefaultPagingValues()
    {
        ...
        service
            .Setup(paymentReceiptService => paymentReceiptService.SearchAsync(null, null, null, 1, 10))
        ...
        service.Verify(paymentReceiptService => paymentReceiptService.SearchAsync(null, null, null, 1, 10), Times.Once);
    }
}
